...
public class ArticleController : ControllerBase
{
    ...
    public IActionResult Update(int id, UpdateArticleDto articleDto)
    {
        try
        {
            ...
            if (!HasAccessToChangeArticle(id, decodedToken)) return Unauthorized();
    ...
    public IActionResult Delete(int articleId)
    {
        try
        {
            ...
            if (!HasAccessToChangeArticle(articleId, decodedToken)) return Unauthorized();
    ...
    private bool HasAccessToChangeArticle(int articleId, JwtSecurityToken decodedToken)
    {
